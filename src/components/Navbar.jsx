        ...
        <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
          ...
          <div className="hidden mdl:inline-flex items-center gap-7">
            <ul className="flex text-[15px] gap-7">
              ...
              >
                ...
                >
                  <span className="text-textGreen">03.</span> Blog
                </motion.li>
              </Link>
              <Link
                href="#contact"
          ...
          {showMenu && (
            <div
              ...
              onClick={handleClick}
              className="absolute mdl:hidden top-0 rigth-0 w-full h-screen bg-black bg-opacity-50 flex flex-col items-end"
            >
              <motion.div
              ...
              >
                ...
                <div className="flex flex-col items-center gap-7">
                  ...
                  <div className="flex gap-4">
                    ...
                    <motion.a
                      ...
                      href="https://github.com/MFahad150"
                      target="_blank"
                    >
                      <span className="w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                        <TbBrandGithub />
                    ...
                    <motion.a
                      ...
                      href="https://medium.com/@mfahad1667"
                      target="_blank"
                    >
                      <span className="w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                        <SiMedium />
                ...
                <motion.a
                  ...
                  href="mailto:mfahad1667@gmail.com"
                >
                  <p>Email Me</p>
                </motion.a>
              </motion.div>
